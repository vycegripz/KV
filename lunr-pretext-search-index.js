...
{
  "id": "subsec-1-1-1-Tables-5",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-1-Tables-5",
  "type": "Table",
  "number": "1.1.2",
...
{
  "id": "subsec-1-1-3-Examples-3",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-3-Examples-3",
  "type": "Table",
  "number": "1.1.3",
...
{
  "id": "subsec-1-1-4-Exercises-2",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-2",
...
{
  "id": "subsec-1-1-4-Exercises-3",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-3",
  "type": "Worksheet Exercise",
  "number": "1.1.4.2",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-4",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-4",
  "type": "Worksheet Exercise",
  "number": "1.1.4.3",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-5",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-5",
  "type": "Worksheet Exercise",
  "number": "1.1.4.4",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-6",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-6",
  "type": "Worksheet Exercise",
  "number": "1.1.4.5",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-7",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-7",
  "type": "Worksheet Exercise",
  "number": "1.1.4.6",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-8",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-8",
  "type": "Worksheet Exercise",
  "number": "1.1.4.7",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-9",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-9",
  "type": "Worksheet Exercise",
  "number": "1.1.4.8",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-10",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-10",
  "type": "Worksheet Exercise",
  "number": "1.1.4.9",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-11",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-11",
  "type": "Worksheet Exercise",
  "number": "1.1.4.10",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-12",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-12",
  "type": "Worksheet Exercise",
  "number": "1.1.4.11",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-13",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-13",
  "type": "Worksheet Exercise",
  "number": "1.1.4.12",
  "title": "",
...
{
  "id": "subsec-1-1-4-Exercises-14",
  "level": "2",
  "url": "sec-1-1-IPA.html#subsec-1-1-4-Exercises-14",
  "type": "Worksheet Exercise",
  "number": "1.1.4.13",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-1-2-Orthography.html#subsec-1-2-1-nasalized-vowels-12",
  "type": "Example",
  "number": "1.2.2",
  "title": "",
  "body": "   KV  IPA  English Approximation    shyin  [ʃjɛ̃]     byin  [bjɛ̃]     manjé  [mɑ̃ʒe]     bonswa  [bɔ̃swa]     gin  [gɛ̃]     jambalaya  [ʒɑ̃balaja]     kompren  [kɔ̃prɑ̃]     montré  [mɔ̃tre]     bonjour  [bɔ̃ʒur]     enfan  [ɑ̃fɑ̃]     aprenn  [apɑ̃n]     enmær  [ɑ̃mær]     ensenm  [ɑ̃sɑ̃m]     nonm  [nɔ̃m]     janm  [ʒɑ̃m]     minm  [mɛ̃m]     tinmbré  [tɛ̃mbre]     promnad  [prɔ̃nad]     ennwiyé  [ɑ̃nwije]     mashinn  [mɑʃin]     "
},
{
  "id": "subsec-1-2-2-alphabet-generalities-2-2",
  "level": "2",
  "url": "sec-1-2-Orthography.html#subsec-1-2-2-alphabet-generalities-2-2",
  "type": "Table",
  "number": "1.2.3",
  "title": "Louisiana Creole Alphabet",
  "body": " Louisiana Creole Alphabet    LC Letter  IPA Symbol  English Phonetic Approximation  English Example or Note       a  [a]  aw  f a ther, au nt, l aw n    æ  [æ]  aa  a pple, b a t, a nt    é  [e]  ay  a , p ay , a ble    e  [ø]  eugh  note: no english equivalent. Round your lips like you're about to say \"Oh\" but say \"ay\" instead.    e  [ə]  uh  th e , a bout, syst e m    è  [ɛ]  eh  b e t, s ai d, br ea d, n e ver    o  [o]  oh  t ow , h o me, b oa t    œ  [œ]  ugh  note: no english equivalent. Round your lips like you're about to say \"Oh\" but say \"eh\" instead.    ò  [ɔ]  au  l o st, th ough t, d o g, aw ful, s au ce    i  [i]  ee  s ee d, happ y     ou  [u]  oo  p oo l, d u ty, m oo n    u  [y]  ew  u se, n ew note: Round your lips like you're about to say \"Oh\" but say \"ee\" instead.       y  [j]  y  y ou, be y ond, b eau tiful    ch  [tʃ]  ch  ch ur ch     dj  [dʒ]  j  j am, gy m, sol di er, bri dge     j  [ʒ]  zh  mer g e, trea su re, vi si on Note: Think of saying \"jjjjjump\"    sh  [ʃ]  sh  sh are, na ti on, spe ci al    ny or ñ  [ɲ]  ny  ca ny on, jalape ñ o    ç  [s]  ss  s top        ay  [aj]  awy  say the english word \"eye\" but starting with \"aw\"    ai  [ai]  aw-ee or aw-yee  n ai ve    inn  [in]  een  mach i ne    imm  [im]  eem  t eam    ènn  [ɛ̃n]      èmm  [ɛ̃m]      "
},
{
  "id": "subsec-1-2-3-examples-3",
  "level": "2",
  "url": "sec-1-2-Orthography.html#subsec-1-2-3-examples-3",
  "type": "Table",
  "number": "1.2.4",
...
},
{
  ...
  "number": "1.2.4.1",
  "title": "",
  "body": "  Match the IPA to it's approximate English sounds:    [bale]  [ublije]  [dusmɑ̃]  [mɑ̃ke]            A-3, B-1, C-4, D-2  "
},
{
  ...
  "number": "1.2.4.2",
  "title": "",
  "body": "  Match the Louisiana Creole word to its IPA:    dousmen  balé  manké  oubliyé    [mɑ̃ke]  [bale]  [ublije]  [dusmɑ̃]      A-4, B-2, C-1, D-3  "
},
{
  ...
  "number": "1.2.4.3",
  "title": "",
  "body": "  Match the Louisiana Creole word to its English approximation:    dousmen  balé  manké  oubliyé            A-2, B-3, C-4, D-1  "
},
{
  ...
  "number": "1.2.4.4",
  "title": "",
  "body": "  Match the word in Louisiana Creole to both its IPA symbol and English approximation by dragging from one box to it's appropriate pair:       fim  fenm  fimm   [fɛ̃]  [fɑ̃m]  [fim]      "
},
{
...
},
{
  ...
  "number": "1.3.3.2",
  "title": "Count to 100.",
  "body": " Count to 100  Try to count to 100 everyday for a week and see if you feel more familiar with your numbers.  "
},
{
  "id": "sec-2-1-Family",
  "level": "1",
  ...
  "number": "2.1",
  "title": "Family",
  "body": " Family    What's Covered  After completing this section you should be at least some what familiar with:  The structure of basic sentences  How to make a basic sentence           Vocabulary  Here are the words we will be using for this section:   Vocab List    LC  IPA  Meaning    wé  [we]  yes, yeah    çé  [se]  it is, to be    shyin  [ʃjɛ̃]  dog    sha(t)  [ʃat]  cat    misye  [misyø, misye]  mister, sir, gentleman    in  [ɛ̃]  a, an    fenm  [fɑ̃m]  woman, wife    madamm  [madɑ̃m]  Mrs., wife, lady    garçon  [garsɔ̃]  boy, son    fiy  [fij]  daughter, girl, woman    osi(t)  [osi]  also, too    li  [li]  it, he\/him, she\/her    itou  [itu]  also, too    non  [nɔ̃]  no    -la  [la]  the (post-nominal)    -layé  [laye]  those (post-nominal)    ki  [ki]  who, what, which    gin  [gɛ̃]  to have    a  [a]  to, at, per    é  [e]  and    pær  [pær]  father    mær  [mær]  mother    fis  [fis]  son    yé  [ye]  they, to be (at end of a sentence)    frær  [frær]  brother    sœr  [sœr]  sister    jish  [jiʃ]  just    pa  [pa]  not (negation marker)    le  [le]  \"the\" for plurality of nouns       Basic Sentence Structure   Basic sentence structure for Louisiana Creole is SVO just like in English:    subject + verb + object       Subject is what we are talking about. It can be a noun or a pronoun.  We will discuss verbs and tenses in a later section.  Object is a noun or pronoun that receives or is the target of the subject.   The boy has a dog.    Subject: boy  Verb: has  Object: dog   In LC the example sentence above would be:   \"Garçon gin in shyin.\"     A general rule for speaking in LC is to leave out any unnecessary information. Many prepositions are left out of sentences if they can be implied. We provide just enough information to get out point across. Notice we don't use a \"the\" term for the boy (garçon) since it adds no additional information to the sentence. \"The\" would only be necessary if there were several boys present and we needed to specify a certain one or group.    The Word for \"The\" (Post-Nominal Determiners)  Post-nominal determiners are little words or phrases we add to the end of a noun to indicate plural and specifics. Think about it as when we say \"the\", the term for \"the\" goes at the end. We could have said   \"Garçon-la gin in shyin.\"   and it would have been an equivalent sentence. We can use the standard French form of \"la\" in front of a noun as well.   \"La garçon gin in shyin.\"   When we see the dash we want to make sure that we pronounce it as a separate syllable with a pause. \"Shyin-la\" is pronounced as \"shyin la\" not \"shyinla\". Post nominal determiners will always be denoted with a hyphen \"-\" in front when given in the vocab sections, like \"-la\" and \"-layé\" above.     Saying \"No\" (Negation)  To make a sentence negative, you use the word pa . Where you put this word depends on the type of action:    \"pa\" before a verb means no for this moment or in general.  Mo pa konné. (I don't know.)      \"pa\" after a verb is a harder, more permanent no.  Mo konné pa. (I don't know [and I never will].)        \"To Be\"  LC handles the \"to be\" differently than English. Sometimes we have a verb for it, and sometimes we don't.     Zero Copula: When you are using an adjective to describe someone (like \"He is sick\"), you do not need a word for \"is\" or \"am\".  Li malad. (He [is] sick.)       Equating Nouns: If you are saying one thing is another thing (like \"He is a man\"), you must use çé .  Li çé in nonm. (He is a man.)       Questions: When asking a question like \"Where are you?\", the verb \"to be\" changes to yê and moves to the end.  Aou to yê? (Where are you?)        Possessive Noun Phrases  In Enlish when a noun (person, place or thing) owns or possesses another noun we usually add an apostrophe and \"s\" to the possessor noun. For example: John's car.  In French we use \"de\/du\" to indicate possession (\"of\" or \"from\"). The noun being possessed comes first, \"car of John\" in this case. In Louisiana Creole we follow the same structure as French but we can use \"de\", which is not common, except for some already made constructs like \"dekann\" (sugar cane) or \"ark-d-syel\" (rainbow), \"a\", or more importantly, as stated above, we leave all of that out as unnecessary information and just say \"car John\".    Shyin John. (most common)  Shyin a John. (not common)  Shyin d John. (least common unless a pre-construct)  John's car.     Immersive Reading: Famiy Duklos  Using the information we learned so far we should be able to get through the section below and answer some questions all in Louisiana Creole!     nonm     fenm       fiy     garçon     garçon     fiy     Misye Duklos çé in nonm. Madamm Duklos çé in fenm. Jean çé in garçon, é Henri çé in garçon. Jean é Henri çé de garçon. Nicole çé in fiy, é Yvonne çé in fiy osit. Nicole é Yvonne çé de fiy.     sha     shyin     shyin     Minet çé in sha. Médor çé in shyin. Fido çé in shyin osit. Médor é Fido çé de shyin.    Médor çé in shyin, li?   Wé, li çé in shyin.   Minet çé in shyin itou, li?   Non, li çé pa in shyin, li çé in sha.   Fido çé in shyin, li?  Wé, li çé in shyin.   Misye Duklos çé in nonm, li?  Wé, li çé in nonm.   Madamm Duklos çé in fenm?  Wé, li çé in fenm.   Jean çé in fenm itou, li?  Non, li çé pa in fenm, li çé in garçon.   Yvonne çé in garcon itou, li?  Non, li çé pa in garçon, li çé in fiy.   Henri çé in garçon?  Wé, li çé in garçon.     Garçon-la çé Jean. Fiy-la çé Nicole. Shyin-layé çé Médor é Fido.    Ki fenm-la yê?  Fenm-la çé Madamm Duklos.   Ki nonm-la yê? Nonm-la çé Misye Duklos.  Ki de shyin yê? De shyin çé Médor é Fido.  Ki garçon-la yê? Garçon-la çé Jean.  Ki fiy-la yê? Fiy-la çé Nicole.  Ki lê Duklos yê? Yé çé Misye é Madamm Duklos, de garçon, Jean é Henri, é de fiy, Nicole é Yvonne.    Jean gin in shyin, é Nicole gin in shyin osit. Médor shyin-la Jean, é Fido shyin-la Nicole. Yvonne gin in sha; Minet shat-la Yvonne.    Médor çé shyin-la a Henri? Non, li çé shyin-la a Jean.  Minet çé sha-la Nicole? Non, li çé sha-la Yvonne.  Fido çé shyin-la a Nicole? Wé, li çé shyin-la a Nicole.  Nonm-la çé Misye Duklos? Wé, nonm-la çé Misye Duklos.  Fenm-la çé Madamm Duklos?, Wé, fenm-la çé Madamm Duklos.     Famiy Duklos     Misye Duklos çé pær Jean; Jean çé fis Misye Duklos. Henri çé fis Misye Duklos osit. Misye Duklos çé pær Nicole é Yvonne. Misye Duklos gin de fis; li gin de fiy itou. Madamm Duklos çé mær Jean, Henri, Nicole é Yvonne. Madamm Duklos gin de fis é li gin de fiy.      Jean, li gin in pær, li?   Wé, li gin in pær.  Ki çé pær a Jean? Misye Duklos.  Misye Duklos, li gin de fis, li? Wé, li gin de fis.  Ki çé lê fis a Misye Duklos? Yé çé Jean é Henri.  Yvonne, li gin in mær? Wé, li gin in mær.        Ki çé mær Yvonne? Madamm Duklos.  Madamm Duklos, li gin de fiy é de fis? Wé, li gin de fiy é de fis.  Ki çé lê fiy é fis Misye é Madamm Duklos? Yé çé Jean, Henri, Nicole é Yvonne.      Jean çé frær Nicole; Nicole çé sœr Jean. Nicole çé sœr Henri é Yvonne itou. Li gin de frær é in sœr. Henri çé frær Jean, Nicole é Yvonne; li gin de sœr é in frær. Jean é Henri gin de sœr; yé gin in pær é in mær itou. Nicole é Yvonne gin de frær, é yé gin in pær é in mær itou.      Jean é Henri, yé gin de sœr? Wé, yé gin de sœr.  Nicole é Yvonne, yé gin in pær? Wé, yé gin in pær.  Yé gin in mær osit? Wé, yé gin in mær.  Misye é Madamm Duklos, yé gin de fiy é de fis? Wé, yé gin de fiy é de fis.  Nicole é Jean, yé gin in frær é in sœr? Wé, yé gin in frær é in sœr.  Ki ça yê? Henri é Yvonne.       Médor é Fido, lê shyin a Henri? Non, Médor é Fido pa lê shyin a Henri; Médor çé shyin a Jean é Fido çé shyin a Nicole.  Jean é Henri, yé de nonm? Non, yé pa de nonm; yé de garçon.  Nicole é Yvonne, yé osit de garçon? Non, yé pa de garçon, yé de fiy.  Jean çé pær Henri? Non, li çé pa pær Henri; li çé frær Henri.  Yvonne çé mær Nicole? Non, li çé pa mær Nicole; li çé sœr Nicole.  Nicole, li gin in sha? Non, li pa gin in sha, li gin in shyin.    Yvonne é Henri pa gin jish in sœr; Henri gin in frær é de sœr, Yvonne gin de frær é in sœr.    Exercises     Kouri-Vini 15x15 Lower-case Grid    f r æ r e  p m æ o s  é j r æ h    t d æ œ m  æ r é o n  s p h j æ    œ p h t m  s é n d p  æ r r œ s    s œ r é o  m f n s e  p æ œ f é    æ d s e p  m n s h y  i n t d é    œ m a d a  m m e p j  h s æ r é    r f é t s  d h y s n  o n m œ r    s h a e p  j n s œ æ  r t d o é    r m é o i  t o u p h  y n e d s    œ f s e h  d y æ œ r  é o s i n    æ œ m i s  y e r p d  t o æ e n    r f é h m  n s e j i  s h œ s é    f i y p h  d e o r æ  œ é p t j    œ r é s p  h t m n é  s p f i s    m æ œ r f  é o n s e  p j h y t     Word Bank:    frær (brother)  mær (mother)  pær (father)  sœr (sister)  fis (son)    fiy (girl)  shyin (dog)  sha (cat)  nonm (man)  madamm (mrs)    misye (mr)  jish (just)  itou (also)  osi (also)      Words are primarily horizontal: r1: frær; r2: mær; r3: pær; r4: sœr; r5: shyin; r6: madamm; r7: nonm; r8: sha; r9: itou; r10: osi; r11: misye; r12: jish; r13: fiy; r14: fis.      "
},
{
  "id": "subsec-2-1-1-vocab-3",
  "level": "2",
  "url": "sec-2-1-Family.html#subsec-2-1-1-vocab-3",
  "type": "Table",
  "number": "2.1.1",
  "title": "Vocab List",
...
{
  "id": "subsec-2-1-2-sentences-2-8",
  "level": "2",
  "url": "sec-2-1-Family.html#subsec-2-1-2-sentences-2-8",
  "type": "Example",
  "number": "2.1.2",
  "title": "",
  "body": " The boy has a dog.  "
},
{
  "id": "sub-negation-3-1-1-1",
  "level": "2",
  "url": "sec-2-1-Family.html#sub-negation-3-1-1-1",
  "type": "Example",
  "number": "2.1.3",
  "title": "",
  "body": " Mo pa konné. (I don't know.)  "
},
{
  "id": "sub-negation-3-2-1-1",
  "level": "2",
  "url": "sec-2-1-Family.html#sub-negation-3-2-1-1",
  "type": "Example",
  "number": "2.1.4",
  "title": "",
  "body": " Mo konné pa. (I don't know [and I never will].)  "
},
{
  "id": "sub-to-be-3-1-1-3",
  "level": "2",
  "url": "sec-2-1-Family.html#sub-to-be-3-1-1-3",
  "type": "Example",
  "number": "2.1.5",
  "title": "",
  "body": " Li malad. (He [is] sick.)  "
},
{
  "id": "sub-to-be-3-2-1-4",
  "level": "2",
  "url": "sec-2-1-Family.html#sub-to-be-3-2-1-4",
  "type": "Example",
  "number": "2.1.6",
  "title": "",
  "body": " Li çé in nonm. (He is a man.)  "
},
{
  "id": "sub-to-be-3-3-1-3",
  "level": "2",
  "url": "sec-2-1-Family.html#sub-to-be-3-3-1-3",
  "type": "Example",
  "number": "2.1.7",
  "title": "",
  "body": " Aou to yê? (Where are you?)  "
},
{
  "id": "subsubsec-possessive-noun-phrases-4",
  "level": "2",
  "url": "sec-2-1-Family.html#subsubsec-possessive-noun-phrases-4",
  "type": "Example",
  "number": "2.1.8",
  "title": "",
  "body": "  Shyin John. (most common)  Shyin a John. (not common)  Shyin d John. (least common unless a pre-construct)  John's car. "
},
{
...
{
  "id": "subsec-2-1-3-reading-13",
  "level": "2",
  "url": "sec-2-1-Family.html#subsec-2-1-3-reading-13",
  "type": "Figure",
  "number": "2.1.18",
  "title": "",
  "body": " Famiy Duklos    "
...
{
  "id": "ex-kouri-wordsearch-lower",
  "level": "2",
  "url": "sec-2-1-Family.html#ex-kouri-wordsearch-lower",
  "type": "Checkpoint",
  "number": "2.1.19",
  "title": "",
  "body": "   Kouri-Vini 15x15 Lower-case Grid    f r æ r e  p m æ o s  é j r æ h    t d æ œ m  æ r é o n  s p h j æ    œ p h t m  s é n d p  æ r r œ s    s œ r é o  m f n s e  p æ œ f é    æ d s e p  m n s h y  i n t d é    œ m a d a  m m e p j  h s æ r é    r f é t s  d h y s n  o n m œ r    s h a e p  j n s œ æ  r t d o é    r m é o i  t o u p h  y n e d s    œ f s e h  d y æ œ r  é o s i n    æ œ m i s  y e r p d  t o æ e n    r f é h m  n s e j i  s h œ s é    f i y p h  d e o r æ  œ é p t j    œ r é s p  h t m n é  s p f i s    m æ œ r f  é o n s e  p j h y t     Word Bank:    frær (brother)  mær (mother)  pær (father)  sœr (sister)  fis (son)    fiy (girl)  shyin (dog)  sha (cat)  nonm (man)  madamm (mrs)    misye (mr)  jish (just)  itou (also)  osi (also)      Words are primarily horizontal: r1: frær; r2: mær; r3: pær; r4: sœr; r5: shyin; r6: madamm; r7: nonm; r8: sha; r9: itou; r10: osi; r11: misye; r12: jish; r13: fiy; r14: fis.   "
},
{
  "id": "backmatter-2",
  "level": "1",

...
},
{
  ...
  "number": "1.2.4",
  "title": "",
  "body": "   LC  IPA  Pronunciation  English Meaning    laj  [laʒ]   age    vrémen  [vremɑ̃]   really    gin  [gɛ̃]   to have    ole  [ole]   to want    m'ole  [m ole]   I want    pe  [pø]   a few, a little    zye  [zyø]   eye    zyé  [zye]   eye    astœr  [astœr]      astèr  [astɛr]   now    rekommandé  [rəkɔ̃mɑ̃de]   to order    rèkommandé  [rɛkɔ̃mɑ̃de]   to order    rékommandé  [rekɔ̃mɑ̃de]   to order    rékòmandé  [rekɔmɑ̃de]   to order    labichud  [labitʃyd]   habit, to be accustomed to    "
},
{
  "id": "backmatter-2",
  "level": "1",
